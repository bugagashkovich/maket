export default function Main() {
  return (
    <div className="relative mt-20 overflow-hidden h-[560px]">
      <div className="flex flex-col container mx-auto h-[560px] justify-between">
        <div>
          <h1 className="text-white text-[50px] opacity-90 mb-6 font-medium">
            Awesome tools for <br></br> Designer & Developer
            <span className="text-[#FF6E30] opacity-100">.</span>
          </h1>
          <h2 className="text-white text-[18px] opacity-50 mb-12">
            Antool is a web collection of information on paid or <br></br>free
            Design and Development tools
          </h2>

          <form className="bg-[#283036] h-[64px] w-[500px] rounded-[15px] flex justify-between items-center p-2 pl-4 ">
            <div className="flex ">
              <svg
                width="25"
                height="24"
        ...
        <div className="flex space-x-8 mb-2">
          ...
          >
            <path
              d="M18.9791 29.7458V18.1347H22.8962L23.4784 13.5887H18.9791V10.693C18.9791 9.38116 19.3446 8.483 21.2274 8.483H23.613V4.42991C22.4523 4.30552 21.2855 4.24545 20.1181 4.25C16.6558 4.25 14.2786 6.36366 14.2786 10.2439V13.5802H10.387V18.1262H14.2871V29.7458H18.9791Z"
              fill="white"
              fill-opacity="0.78"
            />
          </svg>
          ...
          >
            <path
              d="M17.9985 11.0654C16.159 11.0654 14.3948 11.7962 13.094 13.0969C11.7933 14.3977 11.0625 16.1619 11.0625 18.0014C11.0625 19.841 11.7933 21.6052 13.094 22.9059C14.3948 24.2067 16.159 24.9374 17.9985 24.9374C19.838 24.9374 21.6022 24.2067 22.903 22.9059C24.2037 21.6052 24.9345 19.841 24.9345 18.0014C24.9345 16.1619 24.2037 14.3977 22.903 13.0969C21.6022 11.7962 19.838 11.0654 17.9985 11.0654ZM17.9985 22.5059C16.8034 22.5059 15.6573 22.0312 14.8123 21.1862C13.9672 20.3411 13.4925 19.195 13.4925 17.9999C13.4925 16.8049 13.9672 15.6587 14.8123 14.8137C15.6573 13.9687 16.8034 13.4939 17.9985 13.4939C19.1936 13.4939 20.3397 13.9687 21.1847 14.8137C22.0298 15.6587 22.5045 16.8049 22.5045 17.9999C22.5045 19.195 22.0298 20.3411 21.1847 21.1862C20.3397 22.0312 19.1936 22.5059 17.9985 22.5059Z"
              fill="white"
              fill-opacity="0.78"
            />
            <path
              d="M25.209 12.4275C26.1021 12.4275 26.826 11.7035 26.826 10.8105C26.826 9.91744 26.1021 9.19348 25.209 9.19348C24.316 9.19348 23.592 9.91744 23.592 10.8105C23.592 11.7035 24.316 12.4275 25.209 12.4275Z"
              fill="white"
              fill-opacity="0.78"
            />
            <path
              d="M30.7995 9.16645C30.4522 8.26972 29.9216 7.45537 29.2415 6.77553C28.5614 6.0957 27.7468 5.56535 26.85 5.21845C25.8005 4.82448 24.6918 4.61146 23.571 4.58845C22.1265 4.52545 21.669 4.50745 18.006 4.50745C14.343 4.50745 13.8735 4.50745 12.441 4.58845C11.3211 4.61028 10.2131 4.82335 9.16499 5.21845C8.26789 5.56495 7.45314 6.09515 6.77299 6.77504C6.09285 7.45493 5.56233 8.26948 5.21549 9.16645C4.82145 10.2159 4.60891 11.3247 4.58699 12.4454C4.52249 13.8884 4.50299 14.3459 4.50299 18.0104C4.50299 21.6734 4.50299 22.1399 4.58699 23.5754C4.60949 24.6974 4.82099 25.8044 5.21549 26.8559C5.56331 27.7526 6.09433 28.5668 6.77464 29.2466C7.45495 29.9264 8.26959 30.4568 9.16649 30.8039C10.2126 31.2137 11.321 31.442 12.444 31.4789C13.8885 31.5419 14.346 31.5614 18.009 31.5614C21.672 31.5614 22.1415 31.5614 23.574 31.4789C24.6946 31.4562 25.8033 31.2437 26.853 30.8505C27.7496 30.5027 28.5639 29.9719 29.2439 29.2919C29.924 28.6119 30.4548 27.7976 30.8025 26.9009C31.197 25.851 31.4085 24.7439 31.431 23.622C31.4955 22.1789 31.515 21.7214 31.515 18.0569C31.515 14.3924 31.515 13.9274 31.431 12.4919C31.4135 11.3554 31.1999 10.2303 30.7995 9.16645ZM28.9725 23.4644C28.9628 24.3289 28.805 25.1853 28.506 25.9964C28.2807 26.5798 27.9359 27.1094 27.4936 27.5515C27.0513 27.9935 26.5214 28.338 25.938 28.5629C25.1358 28.8606 24.2885 29.0184 23.433 29.0294C22.008 29.0954 21.606 29.1119 17.952 29.1119C14.295 29.1119 13.9215 29.1119 12.4695 29.0294C11.6144 29.019 10.7675 28.8612 9.96599 28.5629C9.38052 28.3394 8.84849 27.9955 8.40433 27.5534C7.96016 27.1113 7.61374 26.5809 7.38749 25.9964C7.09266 25.194 6.93496 24.3477 6.92099 23.4929C6.85649 22.0679 6.84149 21.6659 6.84149 18.0119C6.84149 14.3564 6.84149 13.9829 6.92099 12.5294C6.93069 11.6655 7.08847 10.8096 7.38749 9.99895C7.84499 8.81545 8.78249 7.88395 9.96599 7.43095C10.7679 7.13416 11.6145 6.97639 12.4695 6.96445C13.896 6.89995 14.2965 6.88195 17.952 6.88195C21.6075 6.88195 21.9825 6.88195 23.433 6.96445C24.2886 6.97474 25.136 7.13255 25.938 7.43095C26.5214 7.65636 27.0512 8.00125 27.4934 8.44349C27.9357 8.88573 28.2806 9.41555 28.506 9.99895C28.8008 10.8014 28.9585 11.6477 28.9725 12.5024C29.037 13.9289 29.0535 14.3294 29.0535 17.9849C29.0535 21.6389 29.0535 22.0319 28.989 23.466H28.9725V23.4644Z"
              fill="white"
              fill-opacity="0.78"
            />
          </svg>
      ...
      >
        ...
        <path
          opacity="0.15"
          d="M359.996 10.9343L539.442 114.564L539.357 544.81L359.911 441.266L359.996 10.9343Z"
          fill="url(#paint2_linear_1_421)"
        />
        <path
          d="M326.249 67.2971L469.058 149.674V189.205L326.249 106.828V67.2971Z"
          fill="#587298"
        />
        <path
          opacity="0.2"
          d="M383.373 250.329L518.701 328.455V448.067L383.373 369.941V250.329Z"
          fill="url(#paint3_linear_1_421)"
        />
        <path
          opacity="0.15"
          d="M382.012 158.6L519.38 237.916V251.433L382.012 172.117V158.6Z"
          fill="white"
        />
        <path
          opacity="0.15"
          d="M382.012 185.804L500.764 254.324V267.841L382.012 199.321V185.804Z"
          fill="white"
        />
        <path
          opacity="0.15"
          d="M382.012 212.668L482.828 270.816V284.333L382.012 226.185V212.668Z"
          fill="white"
        />
        <path
          opacity="0.2"
          d="M359.996 10.9343L539.442 114.564V172.202L359.911 68.6576L359.996 10.9343Z"
        ...
        <path
          opacity="0.15"
          d="M36.6372 142.703L589 461.499L588.915 892L36.5522 573.205L36.6372 142.703Z"
          fill="url(#paint5_linear_1_421)"
        />
        <path
          d="M0 248.798L142.723 331.175V370.705L0 288.414V248.798Z"
          fill="#EA8C4F"
        />
        <path
          opacity="0.15"
          d="M73.8689 357.444L390.768 540.39V553.907L73.8689 370.961V357.444Z"
          fill="white"
        />
        <path
          opacity="0.15"
          d="M73.8689 384.648L347.245 542.43V555.947L73.8689 398.165V384.648Z"
          fill="white"
        />
        <path
          opacity="0.15"
          d="M73.8689 411.596L306.528 545.915V559.432L73.8689 425.113V411.596Z"
          fill="white"
        />
        <path
          opacity="0.2"
          d="M22.0158 425.029L253.995 558.923V678.535L22.0158 544.556V425.029Z"
          fill="url(#paint6_linear_1_421)"
        />
        <path
          opacity="0.15"
          d="M45.3922 469.15L229.683 575.5V589.017L45.3922 482.667V469.15Z"
          fill="white"
        />
        <path
          opacity="0.15"
          d="M45.3922 496.354L192.961 581.536V595.053L45.3922 509.785V496.354Z"
          fill="white"
        />
        <path
          opacity="0.2"
          d="M36.6368 142.703L588.235 461.159V519.477L36.6368 201.106V142.703Z"
